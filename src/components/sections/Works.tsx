          ...
          <div className="relative h-[230px] w-full">
            ...
            <div className="card-img_hover absolute inset-0 m-3 flex justify-end gap-2">
              {liveDemo && (
                ...
                >
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="h-1/2 w-1/2 object-contain text-white" viewBox="0 0 16 16">
                    <path d="M4.5 5a.5.5 0 0 0-.5.5v5a.5.5 0 0 0 .5.5h5a.5.5 0 0 0 .5-.5v-5a.5.5 0 0 0-.5-.5h-5Zm1 .5h3v3h-3v-3Z"/>
